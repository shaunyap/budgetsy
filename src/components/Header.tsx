    ...
    <div className="flex justify-between items-center">
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="px-4 h-10 rounded-2xl bg-blue-700/10 border border-blue-700/20 text-blue-600 flex items-center gap-2 text-sm font-bold hover:bg-blue-700/20 transition-all"
        >
